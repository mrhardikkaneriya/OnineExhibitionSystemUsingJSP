    ...
    <section class="page-header bg_img padding-tb">
        ...
        <div class="container">
            <div class="page-header-content-area">
                <h4 class="ph-title">Payment Page</h4>
                <!-- <ul class="lab-ul">
                    <li><a href="#">Home</a></li>
    ...
    <div class="login-section padding-tb">
        <div class="container">
            <div class="account-wrapper">
                <h3 class="title">Payment Now</h3>
                <form class="account-form" action="PaymentServlet" method="post">
				                <%
...
%>
			...
			%>
                    ...
                    <div class="form-group">
                        ...
                        <button class="d-block lab-btn"><span>Pay Now</span></button>
                    </div>
                </form>
