...
if(request.getParameter("e_id") == null){
	...
	System.out.print("Ohhhhhhhhhhh If...." + eid + " " + hid);
}
else
{
	hid = Integer.parseInt(request.getParameter("ho_id"));
	eid = Integer.parseInt(request.getParameter("e_id"));
	
	
	e.setVpe_id(eid);
	e.setHo_id(hid);
	System.out.print("Ohhhhhhhhhhh Else...." + eid + " " + hid);
}
...
<%
				...
				//int amount=100;
				List<Product> list=ProductDAO.getRecordByEventId(hid, eid);
                                ...
                                <div class="col-lg-4 col-sm-6 col-12">
                                    ...
                                    <div class="product-list-item">
                                        ...
                                        <div class="product-content">
                                            ...
                                            <a href="EditProduct.jsp?id=<%=p.getPro_id()%>"><button type="button" class="btn btn-success">Edit</button></a>
															
											<a href="DeleteProduct.jsp?id=<%=p.getPro_id()%>"><button type="button" class="btn btn-danger">Delete</button></a>
											
											<a href="ViewProductFeedback.jsp?id=<%=p.getPro_id()%>"><button type="button" class="btn btn-warning">View Feedback</button></a>	
