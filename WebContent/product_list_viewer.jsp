...
<!-- Mirrored from labartisan.net/demo/kagont/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 Sep 2022 17:37:16 GMT -->
<head>
    <title>Kagont</title>
    <meta charset="UTF-8">
    ...
    <section class="page-header bg_img padding-tb">
        ...
        <div class="container">
            <div class="page-header-content-area">
                <h2 class="ph-title">Product List Page</h2>
                <!-- <ul class="lab-ul">
                            ...
                            <div class="shop-product-wrap lists row justify-content-center">
                                ...
                                <div class="col-lg-4 col-sm-6 col-12">
                                    ...
                                    <div class="product-list-item">
                                        ...
                                        <!-- <button> -->
                                        	<a href="FeedbackForm.jsp?p_id=<%=p.getPro_id()%>">FEEDBACK</a>
                                        <!-- </button> -->
                                    </div>
                                </div>
