<%-- <%@page import="jpc.Services"%>
<%@page import="jpc.User" %>
<%@page import="jpc.UserDAO" %>
<%@page import="membersship.Membership" %>
<%@page import="membersship.MembershipDAO" %>
<%@page import="membersship.PaytmConstants"%>
--%>
...
<%
	response.sendRedirect("StorePaymentDetailsServlet?id="+request.getParameter("id")+"&amount="+request.getParameter("amount"));
%>
</body>
</html>