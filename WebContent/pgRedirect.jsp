<%@page import="payment.PaytmConstants"%>
...
while(paramNames.hasMoreElements()) {
	...
	if(cnt==1)
	{
	    id=mapData.get(paramName)[0];
	}
	if(cnt==5)
	{
		amount=mapData.get(paramName)[0];
	}
	System.out.println("MapDate "+mapData.get(paramName)[0]);
}
...
/* parameters.put("CALLBACK_URL", "http://localhost:8080/Candidate/pgResponse.jsp?id="+id); */
parameters.put("CALLBACK_URL", "http://localhost:8081/Exhibition/pgResponse.jsp?id="+id+"&amount="+amount);
