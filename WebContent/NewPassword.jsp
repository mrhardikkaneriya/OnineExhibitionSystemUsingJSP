...
<body>
    ...
    <section class="page-header padding-tb">
        ...
        <div class="container">
            ...
            <h2 class="ph-title">New Password</h2>
        ...
        <%String email=request.getParameter("email");
          System.out.println(email);%>
            <div class="account-wrapper">
                ...
                <form class="account-form" action="UpdatePassword" method="post">
...
<!-- Mirrored from labartisan.net/demo/kagont/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 Sep 2022 17:37:16 GMT -->
</html>